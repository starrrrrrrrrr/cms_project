...
// 从数据库查询出来的实体转变成前端所需要的json格式
func (shop *Shop) ShopToRespDesc() interface{} {

	rescDesc := map[string]interface{}{
		"id":               shop.Id,
		"name":             shop.Name,
		"address":          shop.Address,
		"phone":            shop.Phone,
		"status":           shop.Status,
		"recent_order_num": shop.RecentOrderNum,
		"rating_count":     shop.RatingCount,
